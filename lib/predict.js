...
// Порог, за которым считаем движение направленным (иначе — боковик). Поднят с 0.12
// до 0.15 по калибровке на бэктесте: направление краткосрочно ≈ случайно, поэтому
// модель по умолчанию молчит («боковик») и зовёт направление только на сильном сигнале.
export const DIR_THRESHOLD = 0.15;
