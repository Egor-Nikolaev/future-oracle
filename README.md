...
| **Google News RSS** (поиск по каждому коину) | ~40 свежих новостей на актив → сентимент | `lib/feeds.js` + `lib/ingest.js` |
...
9. **Новости: по коину, а не общей лентой.** Первая версия брала 2 общих RSS и привязывала
   ...
   на Google News RSS-поиск по каждому активу: ~40 свежих осмысленных новостей на коин, привязка
   ...
   rule-based, приложение не ломается.
